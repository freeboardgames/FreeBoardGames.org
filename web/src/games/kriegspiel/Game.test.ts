...
it('multiplayer and movement test', () => {
  ...
  p0.events.endTurn && p0.events.endTurn();
  ...
  p1.events.endTurn && p1.events.endTurn();
...
it('attack scenario', () => {
  ...
  const atkScenario = {
    ...Game.Kriegspiel,
    setup: (ctx: Ctx) => Game.loadGame(atkScenarioData, ctx),
  };
  ...
  client.events.endTurn && client.events.endTurn();

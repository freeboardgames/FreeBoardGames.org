    ...
    return (
      <g>
        ...
        <g transform="matrix(1,0,0,1,-5.09405,-272.125)">
            <text x="174.308px" y="462.346px" className={css.MoneyCardSVGTitle}>Estate</text>
            <text x="187.552px" y="587.346px" className={css.MoneyCardSVGTitle}>Buyer</text>
        </g>
        <g transform="matrix(1,0,0,1,160,111.819)">
            <text x="202.827px" y="762.873px" className={css.MoneyCardSVGDollar}>$</text>
        </g>
      </g>
    )
  }
    ...
    return (
      <g>
        ...
        <g transform="matrix(1,0,0,1,160,-30.2725)">
            <text x="202.827px" y="762.873px" className={css.MoneyCardSVGDollar}>{this.props.card.value}</text>
        </g>
      </g>
    )
  }
    ...
    return (
      <g>
        ...
        <g transform="matrix(1,0,0,1,-5.09405,-238.902)">
            <text x="174.308px" y="462.346px" className={css.PropertyCardSVGTitle}>Estate</text>
            <text x="187.552px" y="587.346px" className={css.PropertyCardSVGTitle}>Buyer</text>
        </g>
      </g>
    )
  }
    ...
    return (
      <g>
        <g transform="matrix(-1,-1.22465e-16,1.22465e-16,-1,735.272,1049.06)">
            <text x="63.599px" y="189.726px" className={css.PropertyCardSVGText}>{this.props.card.value}</text>
        </g>

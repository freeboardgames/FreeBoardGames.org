...
export const moves = {
    ...
    putToCrib(G: IG, ctx: Ctx, idx: number) {
        ...
        let playTo: ILocation = findCribForPlayer(G, ctx, who);
        let cribMove = {
            from: playFrom,
            to: playTo
        }
...
export const CardTableGame = {
    ...
    setup: () => ({
        count: 0,
        deck: [{ id: 'AS', rank: 13, faced: false, img: './media/png/AS.png' },
        ...
        hands: { north: { playerId: '1', private: [], melds: [], tricks: [], played: [], held: [] }, east: { playerId: '2', private: [], melds: [], tricks: [], played: [], held: [] }, south: { playerId: '3', private: [], melds: [], tricks: [], played: [], held: [] }, west: { playerId: '4', private: [], melds: [], tricks: [], played: [], held: [] } },
        stock: [],

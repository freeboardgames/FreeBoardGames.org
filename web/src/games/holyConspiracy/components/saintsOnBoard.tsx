...
import { ECyNames, CITIES, cityFontSize, getCityTextPosition, cityBoardWidth, ECityTextPosition } from '../constants/cities';
...
export class SainstOnBoard extends React.Component<any, {}> {
    ...
    render() {
        ...
        CITIES.forEach((c, cIdx) => {
            const saints = SAINTS.filter((s) => (c.name === inCity)); 
            if(saints.length > 0){

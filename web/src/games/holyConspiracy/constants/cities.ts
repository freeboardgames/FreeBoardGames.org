...
export enum ECityDotPosition {
  Top, Right, Left, Bottom, Middle, Text
}
...
export const CITIES: ICityData[] = [
  ...
  },
  {
    ...
    isHeadQuarter: null,
    position: { x: cityBoardWidth * 0.27, y: cityBoardHeight - cityImgSize * 0.70 },
    textPosition: ECityTextPosition.Bottom,
  ...
  },
  {
    ...
    isHeadQuarter: null,
    textPosition: ECityTextPosition.Bottom,
    position: { x: cityBoardWidth - cityImgSize * 0.6, y: cityBoardHeight * 0.70},
    dotPosition: [ECityDotPosition.Text, ECityDotPosition.Top],
    textBoxScale: 0.78,
  ...
  },
  {
    ...
    isHeadQuarter: null,
    textPosition: ECityTextPosition.Bottom,
    position: { x: cityBoardWidth*0.50, y: cityBoardHeight*0.29},

...
export const CITIES: ICityData[] = [
  ...
  },
  {
    ...
    isHeadQuarter: null,
    position: { x: cityBoardWidth * 0.3, y: cityBoardHeight * 0.89 },
    textPosition: ECityTextPosition.Bottom,
  ...
  },
  {
    name: ECyNames.Laos,
    isHeadQuarter: null,
    position: { x: cityBoardWidth * 0.72, y: cityBoardHeight * 0.86 },
    textPosition: ECityTextPosition.Bottom,
    dotPosition: [ECityDotPosition.Middle],
  ...
  },
  {
    ...
    position: { x: cityBoardWidth * 0.28, y: cityImgSize / 2 },
    connected: [ECyNames.Tibet],
  },
  {
    name: ECyNames.Shimla,
    isHeadQuarter: null,
    position: { x: cityBoardWidth * 0.29, y: cityBoardHeight * 0.19 },
    textPosition: ECityTextPosition.Bottom,
  ...
  },
  {
    ...
    isHeadQuarter: null,
    textPosition: ECityTextPosition.Bottom,
    position: { x: cityBoardWidth * 0.3, y: cityBoardHeight * 0.66 },
    connected: [ECyNames.Mumbai],
  },
  {
  ...
  },
  {
    ...
    isHeadQuarter: null,
    textPosition: ECityTextPosition.Bottom,
    position: { x: cityBoardWidth * 0.7, y: cityBoardHeight * 0.67 },
  ...
  },
  {
    ...
    isHeadQuarter: null,
    textPosition: ECityTextPosition.Top,
    position: { x: cityBoardWidth * 0.715, y: cityBoardHeight * 0.27 },
  ...
  },
  {
    ...
    isHeadQuarter: null,
    textPosition: ECityTextPosition.Bottom,
    position: { x: cityBoardWidth * 0.48, y: cityBoardHeight * 0.29 },

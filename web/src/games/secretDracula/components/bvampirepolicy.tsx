...
export class BVampirePolicies extends React.Component<InnerWrapper, {}> {
    ...
    return (
      <div className={css.tooltip}>
        ...
        <span className={css.tooltiptext}>
          ...
          <b> investigates </b> any other player. If this player is a vampire, the Mayor will see a 🩸 . Otherwise the
          Mayor will see a 💧. NOTE: This does not reveal if a vampire is
          <div className={css2.dracula}>
            {' '}
            <b>Dracula</b>
          </div>
          .
  ...
  _special = () => {
    return (
      <div className={css.tooltip}>
        ...
        🗳️
        <span className={css.tooltiptext}>
          When 🩸 is played here, the current Mayor 🏅 choses the next Mayor, resulting in a <b> special election </b>.
          If this election passes with suficient 👍 votes, there is a special Mayor. After this term, the player after
          the current Mayor will be the next Mayor. It is possible for this player to be the same player as the special
          Mayor, allowing this player two consecutive terms as Mayor.
        </span>
      </div>
    );
  };
    ...
    return (
      <div className={css.tooltip}>
        ...
        <span className={css.tooltiptext}>
          ...
          <b> analysis </b> of the next three samples. The Mayor thus knows the following three samples, for example
          🩸💧💧.
        </span>
      </div>
    );
  ...
  _kill = () => {
    return (
      <div className={css.tooltip}>
        🗡️
        <span className={css.tooltiptext}>
          When 🩸 is played here, the current Mayor 🏅 choses one player to <b>execute</b>. If{' '}
          <div className={css2.dracula}>
            {' '}
            <b>Dracula</b>
          </div>{' '}
          is killed, the humans win!
        </span>
      </div>
    );
  };
  ...
  _death = () => {
    return (
      <div className={css.tooltip}>
        ⚰️
        <span className={css.tooltiptext}>When 🩸 is played here the vampires win.</span>
      </div>
    );
  };

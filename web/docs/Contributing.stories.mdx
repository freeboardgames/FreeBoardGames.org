...
Therefore, we cannot use games art, name, or rules copy without written consent from the copyright owners. Also, we cannot develop games if they have a patent on their rules (rare, but possible).

...
import { parseGameSummary } from 'infra/games/GameSummaryParser';import { PropaneSharp } from '@mui/icons-material';
        ...
        <List>
          {contributors.map((contributor) => (
            <ListItem key={contributor}>
             ...
             <ListItemText primary={<a id={contributor}>{contributor}</a>} secondary={props.contributorsToGames[contributor].join(', ')} />

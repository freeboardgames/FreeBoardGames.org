...
const Logo = ({ width, height }) => (
  <svg width={width || 128} height={height || 128} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
    <path d="M64,120.37,15.27,92.28V35.91L64,7.82l48.73,28.09V92.28Z" fill="#373748" />
    <path
      fill="#000"
    ...
    <path
      ...
      fill="#fff"
    />
    <path d="M39.35,71.45l.19,12.8H33.43L33.62,72l-.19-28.48h6.11l-.19,27.9Z" fill="#fff" />
  </svg>
);

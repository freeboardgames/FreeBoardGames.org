...
(function(s, H, f, w) {
  ...
  f.extend(b, {
      ...
      if (a && (f.isPlainObject(d) || (d = {}), !1 !== b.close(!0)))
        return (
          ...
          f.each(a, function(e, c) {
            ...
            !n &&
              l.isDom &&
              ((n = c.data('fancybox-type')), n || (n = (n = c.prop('class').match(/fancybox\.(\w+)/)) ? n[1] : null));
            r(g) &&
              (n ||
                (b.isImage(g)
                  ? (n = 'image')
    ...
    bindEvents: function() {
      ...
      a &&
        (q.bind(
          'orientationchange.fb' + (t ? '' : ' resize.fb') + (a.autoCenter && !a.locked ? ' scroll.fb' : ''),
          b.update,
        ),
        (d = a.keys) &&
        ...
        f.fn.mousewheel &&
          ...
          b.wrap.bind('mousewheel.fb', function(d, c, l, g) {
            for (
              ...
              h.length && !(k || h.is('.fancybox-skin') || h.is('.fancybox-wrap'));
            ...
            0 !== c &&
              ...
              1 < b.group.length &&
              !a.canShrink &&
              (0 < g || 0 < l ? b.prev(0 < g ? 'down' : 'left') : (0 > g || 0 > l) && b.next(0 > g ? 'up' : 'right'),
              d.preventDefault());
          }));
    },
